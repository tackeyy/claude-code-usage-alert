# Contributing to claude-code-usage-alert

Thank you for your interest in contributing to claude-code-usage-alert! This document provides guidelines and
instructions for contributing to the project.

## 🙏 Welcome!

claude-code-usage-alert is a CLI tool for managing Zoom meetings via Server-to-Server OAuth. We welcome
...
- ✨ **Adding new features** - Expand claude-code-usage-alert's capabilities (discuss first!)
...
git clone https://github.com/YOUR_USERNAME/claude-code-usage-alert.git
...
- 💬 **Questions** - Open a [GitHub Discussion](https://github.com/tackeyy/claude-code-usage-alert/discussions)
- 🐛 **Bug Reports** - Open an [Issue](https://github.com/tackeyy/claude-code-usage-alert/issues/new?template=bug_report.yml)
- 💡 **Feature Requests** - Open an [Issue](https://github.com/tackeyy/claude-code-usage-alert/issues/new?template=feature_request.yml)
- ❓ **General Questions** - Open an [Issue](https://github.com/tackeyy/claude-code-usage-alert/issues/new?template=question.yml)
...
Thank you for contributing to claude-code-usage-alert! Your efforts help make this tool better for everyone.
